...
```sh
bun run capture -- --url "https://map.crabcraft.net/#world:0:0:0:1000:0:0:0:1:flat" --minutes 15
```
...
```sh
bun run capture:once -- --url "https://map.crabcraft.net/#world:0:0:0:1000:0:0:0:1:flat"
